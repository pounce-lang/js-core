...
const pinnaParser = () => {
  const parser_actions = {
    ...
    make_pounce_pl: function (input: any, start: any, end: any, elements: any) {
      var list = [elements[1]];
      elements[2].forEach(function (el: any) { list.push(el.value) });
      return list;
    },

    make_word: function (input: any, start: any, end: any, elements: any) {
      return input.substring(start, end);
    },

    make_map: function (input: any, start: any, end: any, elements: any) {
      var map: any = {};
      if (elements.length = 6) {
        map[elements[2][0]] = elements[2][1];
        elements[3].elements.forEach(function (el: any) {
    ...
    make_pair: function (input: any, start: any, end: any, elements: any) {
      return [elements[0], elements[4]];
    },

    make_string_s: function (input: any, start: any, end: any, elements: any) {
      return "'" + elements[1].text + "'";
    },
    make_string_d: function (input: any, start: any, end: any, elements: any) {
      return '"' + elements[1].text + '"';
    },
    make_string_t: function (input: any, start: any, end: any, elements: any) {
      return '`' + elements[1].text + '`';
    },

    make_list: function (input: any, start: any, end: any, elements: any) {
      var list = [elements[2]];
      elements[3].forEach(function (el: any) { list.push(el.value) });
      return list;
    },

    make_list_empty: function (input: any, start: any, end: any, elements: any): any {
      return [];
    },

    make_integer: function (input: any, start: any, end: any, elements: any) {
      return parseNumber(input.substring(start, end));
    },

    make_float: function (input: any, start: any, end: any, elements: any) {
      return parseNumber(input.substring(start, end));
    },

    make_ws: function (input: any, start: any, end: any, elements: any): any {
      return null;
    }
  };
  ...
  var formatError = function (input: string, offset: number, expected: string[]) {
  ...
  var inherit = function (subclass: any, parent: any) {
  ...
  var TreeNode: any = function (text: string, offset: number, elements: any) {
    this.text = text;
    this.offset = offset;
    this.elements = elements || [];
  };

  TreeNode.prototype.forEach = function (block: any, context: any) {
    for (var el = this.elements, i = 0, n = el.length; i < n; i++) {
      block.call(context, el[i], i, el);
    }
  };

  var TreeNode1 = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['value'] = elements[1];
  };
  inherit(TreeNode1, TreeNode);

  var TreeNode2: any = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['value'] = elements[1];
  };
  inherit(TreeNode2, TreeNode);

  var TreeNode3: any = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['pair'] = elements[2];
  };
  inherit(TreeNode3, TreeNode);

  var TreeNode4 = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
  ...
  var TreeNode5 = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['value'] = elements[2];
  };
  inherit(TreeNode5, TreeNode);

  var TreeNode6: any = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['value'] = elements[1];
  };
  inherit(TreeNode6, TreeNode);

  var TreeNode7 = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['end_of_word'] = elements[4];
  };
  inherit(TreeNode7, TreeNode);

  var TreeNode8 = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['end_of_word'] = elements[3];
  };
  inherit(TreeNode8, TreeNode);

  var TreeNode9 = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
    this['end_of_word'] = elements[3];
  };
  inherit(TreeNode9, TreeNode);

  var TreeNode10 = function (text: string, offset: number, elements: any) {
    TreeNode.apply(this, arguments);
  ...
  var Grammar = {
    ...
    _read_pounce_pl: function () {
      ...
      if (address1 !== FAILURE) {
        ...
        if (address3 !== FAILURE) {
          ...
          var remaining1 = 0, index3 = this._offset, elements2 = [], address5: any = true;
          while (address5 !== FAILURE) {
            var index4 = this._offset, elements3 = new Array(2);
            var address6: any = FAILURE;
    ...
    _read_word: function () {
      ...
      var address1 = FAILURE;
      var remaining0 = 1, index2 = this._offset, elements1 = [], address2: any = true;
      while (address2 !== FAILURE) {
        var chunk0 = null;
      ...
      if (address1 !== FAILURE) {
        elements0[0] = address1;
        var address3 = FAILURE;
        var remaining1 = 0, index3 = this._offset, elements2 = [], address4: any = true;
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          if (address4 !== FAILURE) {
            ...
            var remaining1 = 0, index4 = this._offset, elements2 = [], address6: any = true;
            while (address6 !== FAILURE) {
              var index5 = this._offset, elements3 = new Array(3);
              var address7: any = FAILURE;
    ...
    _read_string_s: function () {
      ...
      if (address1 !== FAILURE) {
        elements0[0] = address1;
        var address2 = FAILURE;
        var remaining0 = 0, index2 = this._offset, elements1 = [], address3: any = true;
        while (address3 !== FAILURE) {
          var chunk1 = null;
          if (this._offset < this._inputSize) {
            chunk1 = this._input.substring(this._offset, this._offset + 1);
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          if (address4 !== FAILURE) {
            elements0[2] = address4;
            var address5 = FAILURE;
            var remaining1 = 0, index3 = this._offset, elements2 = [], address6: any = true;
            while (address6 !== FAILURE) {
              var index4 = this._offset, elements3 = new Array(2);
              var address7: any = FAILURE;
    ...
    _read_float1: function () {
      ...
      if (address1 !== FAILURE) {
        elements0[0] = address1;
        var address2 = FAILURE;
        var remaining0 = 1, index3 = this._offset, elements1 = [], address3: any = true;
        while (address3 !== FAILURE) {
          var chunk1 = null;
          if (this._offset < this._inputSize) {
            chunk1 = this._input.substring(this._offset, this._offset + 1);
        ...
        if (address2 !== FAILURE) {
          ...
          if (address4 !== FAILURE) {
            elements0[2] = address4;
            var address5 = FAILURE;
            var remaining1 = 1, index4 = this._offset, elements2 = [], address6: any = true;
            while (address6 !== FAILURE) {
              var chunk3 = null;
              if (this._offset < this._inputSize) {
    ...
    _read_float2: function () {
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          elements0[1] = address2;
          var address3 = FAILURE;
          var remaining0 = 1, index3 = this._offset, elements1 = [], address4: any = true;
          while (address4 !== FAILURE) {
            var chunk2 = null;
            if (this._offset < this._inputSize) {
              chunk2 = this._input.substring(this._offset, this._offset + 1);
        ...
        if (address0 === FAILURE) {
          ...
          if (address0 === FAILURE) {
            ...
            if (address0 === FAILURE) {
              ...
              if (address0 === FAILURE) {
                this._offset = index1;
                var remaining0 = 1, index7 = this._offset, elements0 = [], address1: any = true;
                while (address1 !== FAILURE) {
                  var chunk4 = null;
                  if (this._offset < this._inputSize) {
  ...
  const cbaNumber = (s: string): number | string => {
    let num;
