...
let tests = [
    ...
    // ['2 3 [+] leap', 'N N [[N N] [N] comp] [F] [F run] bind', 'N'],
    // ['2 3 5 + +', 'N N N [N N] [N] comp [N N] [N] comp', 'N'],
    // ['2 3 5 [+ +] leap', 'N N N [[N N] [N] comp [N N] [N] comp] [F] [F run] bind', 'N'],
    
    // ['1 2 3 [5 + [2 + 6 *] dip] dip', 'N N N [N [N N] [N] comp [N [N N] [N] comp N [N N] [N] comp] [A F] [F run A] bind] [A F] [F run A] bind', 'N N N'],
    // ['2 3 [[+] leap] leap', 'N N [[[N N] [N] comp] [F] [F run] bind] [F] [F run] bind', 'N'],
    // ['2 3 [[[+] leap] leap] leap', 'N N [[[[N N] [N] comp] [F] [F run] bind] [F] [F run] bind] [F] [F run] bind', 'N'],
    // ['2 [3 [[+] leap] leap] leap', 'N [N [[[N N] [N] comp] [F] [F run] bind] [F] [F run] bind] [F] [F run] bind', 'N'],
    // ['2 [3 [+] leap] leap', 'N [N [[N N] [N] comp] [F] [F run] bind] [F] [F run] bind', 'N'],
    ...
    // ['true [true &&] leap', 'B [B [B B] [B] comp] [F] [F run] bind', 'B'],
    ...
    // ['4 3 [[8 +] dip] leap', 'N N [[N [N N] [N] comp] [A F] [F run A] bind] [F] [F run] bind', 'N N'],
    // ['4 3 [5 - [8 +] dip] leap', 'N N [N [N N] [N] comp [N [N N] [N] comp] [A F] [F run A] bind] [F] [F run] bind', 'N N'],
    // ['4 3 [[8 +] dip 5 -] leap', 'N N [[N [N N] [N] comp] [A F] [F run A] bind N [N N] [N] comp] [F] [F run] bind', 'N N'],
