...
let tests = [
    ['2', [{"type":"(int | float)","w":"2"}]],
    ['2 3 +', [{"type":"(int | float)","w":"+"}]],
    ['2 abc +', [{"error":"An unexpected stack type of string with value 'abc' was encountered by +","word":"+","stackDepth":0,"expectedType":"(int | float)","encounteredType":"string","encounterdValue":"abc"}]],
