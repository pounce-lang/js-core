...
allPassing &= testIt("[dup2] word", [{"sig":{"in":[{"type":"A","use":"observe"},{"type":"B","use":"observe"}],"out":[{"type":"A"},{"type":"B"}]},"compose":[["dup"],"dip","dup",["swap"],"dip"]}]);
allPassing &= testIt("[word] word", [{"sig":{"in":[{"type":["A"]}],"out":[{"type":"record"}]}}]);
