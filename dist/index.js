...
var mbr = function (s, dt_sig) {
    ...
    var matches = r.reduce(function (acc, e) { return (acc && (stack_section.pop() === e)); }, true, bound);
...
function dtCheck(orig_pl) {
    ...
    while ((w = pl.shift()) !== undefined) {
        ...
        if (wds) {
            s = r.concat(s, mbr(s, toPLOrNull(parser(wds === null || wds === void 0 ? void 0 : wds.dt))));
        }
        else if (w !== undefined && s !== null) {
