...
export declare const preProcessCheckTypes: (pl: import("./types").ProgramList, wd: import("./WordDictionary.types").WordDictionary, logging?: boolean) => any[] | "not implemented";
